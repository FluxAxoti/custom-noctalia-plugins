...
# This is a **fork** of [community-plugins](https://github.com/noctalia-dev/community-plugins)

This repo **IS NOT** the **community** plugin source, or **official** plugin source for [Noctalia](https://github.com/noctalia-dev/noctalia). All plugins here have been made by myself, and are not available in the plugin browser by default. You must manually add this repo as a source.
...
Plugins maintained by the community members in
[community-plugins](https://github.com/noctalia-dev/community-plugins), which accepts third-party plugins, and PRs.
